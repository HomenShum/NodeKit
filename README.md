...
Before expanding the build, use the 90-second field card in the
[idea-to-reality principles](docs/IDEA_TO_REALITY_PRINCIPLES.md) to freeze one user job, one primary
artifact, the complexity budget, authority boundaries, proof, and the observation that will drive
the next iteration.
